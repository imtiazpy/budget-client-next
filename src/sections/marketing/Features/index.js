          ...
          <Col xs="auto" className="col-xl-8 col-lg-10">
            <Feature.Box mb="35px" mbMD="80px" mbLG="148px">
              ...
              <Feature.Text className="mt-8" fontColor="#fff">
                Create custom landing pages with MillionChallenge that converts
              ...
              <Tab.Pane eventKey="first">
                <Row className="align-items-center">
                  <Col
                    ...
                    xs="auto"
                  >
                    <TabContentWidget count="01." title="Real data access" text={'Create custom landing pages with<br className="d-none d-lg-block" /> MillionChallenge that converts more visitors <br className="d-none d-lg-block" /> than any website.'}/>
                  </Col>
                  <Col
                    className="col-md-6 col-sm-6 col-xs-9"
                    xs="auto"
                  >
                    <TabContentWidget count="02." title="Daily email reports" text={'Create custom landing pages with<br className="d-none d-lg-block" /> MillionChallenge that converts more visitors <br className="d-none d-lg-block" /> than any website.'}/>
                  </Col>
                </Row>
              </Tab.Pane>
              <Tab.Pane eventKey="second">
                <Row>
                  <Col
                    ...
                    xs="auto"
                  >
                    <TabContentWidget count="03." title="Real data access" text={'Create custom landing pages with<br className="d-none d-lg-block" /> MillionChallenge that converts more visitors <br className="d-none d-lg-block" /> than any website.'}/>
                  </Col>
                  <Col
                    className="col-md-6 col-sm-6 col-xs-9"
                    xs="auto"
                  >
                    <TabContentWidget count="04." title="Data access real " text={'Create custom landing pages with<br className="d-none d-lg-block" /> MillionChallenge that converts more visitors <br className="d-none d-lg-block" /> than any website.'}/>
                  </Col>
                </Row>
              </Tab.Pane>
              <Tab.Pane eventKey="third">
                <Row>
                  <Col
                    ...
                    xs="auto"
                  >
                    <TabContentWidget count="05." title="Real data access" text={'Create custom landing pages with<br className="d-none d-lg-block" /> MillionChallenge that converts more visitors <br className="d-none d-lg-block" /> than any website.'}/>
                  </Col>
                  <Col
                    className="col-md-6 col-sm-6 col-xs-9"
                    xs="auto"
                  ...
                  >
                    <TabContentWidget count="06." title="Real access data " text={'Create custom landing pages with<br className="d-none d-lg-block" /> MillionChallenge that converts more visitors <br className="d-none d-lg-block" /> than any website.'}/>
                  </Col>
                </Row>
              </Tab.Pane>
            </Tab.Content>
