      ...
      <Col xs="12" className="col-xl-5 col-lg-6 col-md-7 col-md-7 col-xs-9 order-2 order-lg-1">
          <Content.Box mt="40px" mtLG="0px">
            ...
            <Content.Text>Create custom landing pages
              with MillionChallenge<br className="d-none d-sm-block" /> that converts more visitors than any<br className="d-none d-sm-block" /> website. Easy, Reliable &amp; Fast.</Content.Text>
          </Content.Box>
      </Col>
