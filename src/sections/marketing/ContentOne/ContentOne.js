    ...
    <Row className="align-items-center justify-content-center">
      ...
      <Col xs="auto" className="col-xxl-4 col-xl-5 offset-xl-1 col-lg-6 offset-lg-1 col-md-8 col-xs-9">
        ...
        <Content.Text>Create custom landing pages
          with MillionChallenge that converts more visitors than any website. Easy, Reliable &amp; Fast. The best medicines &amp; biggest brands within 30 minutes at your home.</Content.Text>
      </Col>
    </Row>
  </Container>
</Content>
